module.exports.config = {
	...
	version: "1.0.0",
	hasPermssion: 0,
	credits: "Mod lại của Mr.ben",
	description: "Tạo info bản thân",
	commandCategory: "Tiện ích",
	usages: "Tạo info bản thân",
	cooldowns: 5
};
...
// const sinhnhat = data.birthday;
  ...
  var background = ["https://i.imgur.com/RP58bgF.jpg"];
...
family: "time"
    ...
    ctx.font = "30px time"; ctx.fillText(`- Tên: ${name}\n- Biệt danh:\n${username == true ? "không có" : username}\n- Giới tính: ${gender == "MALE" ? "Nam" : "Nữ"}`, 350, 150)
ctx.restore();
    ctx.save();
    ctx.beginPath(); 
