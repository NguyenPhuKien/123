...
module.exports.languages = {
    ...
    "returnGuide": "=====『 𝐇𝐔̛𝐎̛́𝐍𝐆 𝐃𝐀̂̃𝐍 𝐒𝐔̛̉ 𝐃𝐔̣𝐍𝐆 』=====\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n-user ban → Dùng để ban 1 người cách dùng lệnh /user ban uid hoặc tag\n-user unban → Dùng để mở ban cho 1 người nào đó"
	},
	"en": {
		"reason": "Reason",
		"at": "At",
...
module.exports.run = async ({ event, api, args, Users, getText }) => {
	...
	switch (type) {
        ...
        default: {
            return api.sendMessage(getText("returnGuide"), threadID, messageID)
        }
	}
}