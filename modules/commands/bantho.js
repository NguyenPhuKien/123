...
try {
  ...
  const canvas = Canvas.createCanvas(960, 634);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "Thành kính phân ưu , Bạn hưởng dương 150 tuổi"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
