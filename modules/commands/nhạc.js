...
module.exports.handleReply = async function ({ api, event, handleReply }) {
    ...
    try {
        ...
        if (fs.statSync(path).size > 26214400) return api.sendMessage('Không thể gửi bài trên 10 phút , Vui lòng chọn bài khác!', event.threadID, () => fs.unlinkSync(path), event.messageID);
