...
module.exports.handleReaction = async function({ api, event, Threads, Users, Currencies, handleReaction }) {
    ...
    switch (type) {
        case '1': {
            ...
            await Currencies.setData(senderID, { money: money - 1000000 });
            var genderFilter = [];
...
module.exports.image = async function(link) {
    ...
    let download = (await axios.get(link, { responseType: "arraybuffer" } )).data; 
        writeFileSync( __dirname + `/game/heodenroi.png`, Buffer.from(download, "utf-8"));
        images.push(createReadStream(__dirname + `/game/heodenroi.png`));
    return images
}
...
module.exports.canvas = async function(idOne, idTwo, type) {
    ...
    let path = __dirname + "/game/ghep.png";
    let pathAvata = __dirname + `/game/avtghep2.png`;
    let pathAvataa = __dirname + `/game/avtghep.png`;
