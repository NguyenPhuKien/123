...
if (args.length == 0) return api.sendMessage(`====『SET MONEY』====\n━━━━━━━━━━━━━━━\n- setmoney add → Thêm số tiền cho người ta , bạn có thể reply hoặc tag số tiền mong muốn\n- setmoney set → Chỉnh lại số tiền cho chính bản thân mình , có thể dùng tag hoặc reply người khác để chỉnh lại theo số mình muốn\n- setmoney all → Thêm toàn bộ tiền cho cả nhóm\n- setmoney clean - Lệnh này bạn sẽ xóa số tiền người được tag sau đó\n━━━━━━━━━━━━━━━\nCách dùng sử dụng cách lệnh trên + số tiền ( nếu có tag thì số tiền xong tag )`, event.threadID, event.messageID);
