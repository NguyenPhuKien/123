...
module.exports.run = async ({ event, api, args }) => {
    ...
    else api.sendMessage('Xin chào các bạn mình là bot của Bảo An\nRất vui được gặp các bạn có gì thắc mắc liên hệ fb: facebook.com/hotrobotmess', idBox, (error, info) => {
