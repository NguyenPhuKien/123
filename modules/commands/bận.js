...
dest = __dirname + '/noprefix/bận.json'
      ...
      out(
        z.dataTags.length == 0
          ...
          : `=== [ 𝗔𝗙𝗞 ] ===\n→ 𝗗𝘂̛𝗼̛́𝗶 đ𝗮̂𝘆 𝗹𝗮̀ 𝗱𝗮𝗻𝗵 𝘀𝗮́𝗰𝗵  ${
              ...
              .map(
                (i, c) =>
                  `${c + 1}. 𝐓𝐞̂𝐧 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐭𝐚𝐠 : ${global.data.userName.get(
                    i.id
...
module.exports.run = function ({ api, event, args }) {
  try {
    ...
    if (!!args[0]) {
      ...
      out(
        `[=== [ 𝗕𝗨𝗦𝗬 ] === ]\n━━━━━━━━━━━━━━━\n→ 𝗩𝘂̛̀𝗮 𝘁𝗵𝗶𝗲̂́𝘁 𝗹𝗮̣̂𝗽 𝐛𝐚̣̂𝐧 𝗰𝗵𝗼 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴 𝗩𝗼̛́𝗶 𝗹𝗶́ 𝗱𝗼: ${msg}\n→ 𝗧𝘂̛̣ 𝗯𝗮̣̂𝘁 𝘀𝗮𝗼 ${
          delay % 60
      ...
      if (!data[event.senderID]) {
        return out(
          `→ 𝗕𝗮̣𝗻 𝗰𝗵𝘂̛𝗮 𝘁𝗵𝗶𝗲̂́𝘁 𝗹𝗮̣̂𝗽 𝐛𝐚̣̂𝐧\n→ đ𝗲̂̉ 𝘁𝗵𝗶𝗲̂́𝘁 𝗹𝗮̣̂𝗽 𝗻𝗵𝗮̣̂𝗽 /𝐛𝐚̣̂𝐧 𝗹𝗶́ 𝗱𝗼 & 𝘁𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻 ( 𝗽𝗵𝘂́𝘁 ) 𝘁𝘂̛̣ 𝗯𝗮̣̂𝘁 𝘀𝗮𝗼 𝗸𝗵𝗶 𝗯𝗮̣𝗻 𝗿𝗼̛̀𝗶 𝗸𝗵𝗼̉𝗶`,
          true
        )
      }
      out(
