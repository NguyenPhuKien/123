...
module.exports.run = async function ({ api, event, Users, Threads }) {
    ...
    const type = (event.author == event.logMessageData.leftParticipantFbId) ? "không xin phép,tự ý rời" : "bị quản lý đuổi";
	const path = join(__dirname, "cache", "leaveGif");
    ...
    (typeof data.customLeave == "undefined") ? msg = "Tạm biệt bạn {name} 😞\nLý do: {type}" : msg = data.customLeave;
